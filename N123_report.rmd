...
The first step is to bring the six libraries into the environment using `read.table`.
...
![](H3lenplots.png)
# will have to center this manuall in <html> file
